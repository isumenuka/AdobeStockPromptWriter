...
interface AbstractWaveHistoryItemProps {
...
const AbstractWaveHistoryItem: React.FC<AbstractWaveHistoryItemProps> = ({ prompt, onFeedbackChange, onAddCsvEntry, onPromptUpdate }) => {
    ...
    <div className="bg-gray-50 rounded-lg border border-gray-200">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="font-medium text-gray-900">AbstractWave</span>
        ...
        <div className="px-3 pb-3">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Wave:</span> {prompt.waveDescriptor}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Gradient:</span> {prompt.gradientType}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Color 1:</span> {prompt.colorPalette1}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Color 2:</span> {prompt.colorPalette2}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Color 3:</span> {prompt.colorPalette3}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Depth:</span> {prompt.depthEffect}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Lighting:</span> {prompt.lightingStyle}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Keywords:</span> {prompt.optionalKeywords}
            </div>
          </div>
        </div>
      )}
...
export default AbstractWaveHistoryItem;