...
interface WhiteFrameHistoryItemProps {
  prompt: GeneratedWhiteFramePrompt;
...
const WhiteFrameHistoryItem: React.FC<WhiteFrameHistoryItemProps> = ({ prompt, onFeedbackChange, onAddCsvEntry, onPromptUpdate }) => {
    ...
    <div className="bg-gray-50 rounded-lg border border-gray-200">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="font-medium text-gray-900">White Frame Mockup</span>
        ...
        <div className="px-3 pb-3">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Frames:</span> {prompt.frameNumber}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Orientation:</span> {prompt.frameOrientation}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Wall:</span> {prompt.wallColor}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Ratio:</span> {prompt.aspectRatio}
            </div>
            <div className="text-gray-600 col-span-2">
              <span className="font-medium text-gray-700">Main:</span> {prompt.mainFurniturePiece}
            </div>
            <div className="text-gray-600 col-span-2">
              <span className="font-medium text-gray-700">Additional:</span> {prompt.additionalFurniturePiece}
            </div>
          </div>
        </div>
      )}
...
export default WhiteFrameHistoryItem;