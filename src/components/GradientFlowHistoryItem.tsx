...
interface GradientFlowHistoryItemProps {
  prompt: GeneratedGradientFlowPrompt;
...
const GradientFlowHistoryItem: React.FC<GradientFlowHistoryItemProps> = ({ prompt, onFeedbackChange, onAddCsvEntry, onPromptUpdate }) => {
    ...
    <div className="bg-gray-50 rounded-lg border border-gray-200">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="font-medium text-gray-900">GradientFlow</span>
        ...
        <div className="px-3 pb-3">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Color 1:</span> {prompt.color1}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Color 2:</span> {prompt.color2}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Color 3:</span> {prompt.color3}
            </div>
            <div className="text-gray-600">
              <span className="font-medium text-gray-700">Background:</span> {prompt.backgroundColor}
            </div>
            <div className="text-gray-600 col-span-2">
              <span className="font-medium text-gray-700">Style:</span> {prompt.colorSpreadStyle}
            </div>
          </div>
        </div>
      )}
...
export default GradientFlowHistoryItem;